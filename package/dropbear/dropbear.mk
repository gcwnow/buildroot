...
define DROPBEAR_ALLOW_BLANK_PASSWORD
	$(SED) 's,^/\* #define ALLOW_BLANK_PASSWORD.*,#define ALLOW_BLANK_PASSWORD,' $(@D)/options.h
endef
...
ifeq ($(BR2_PACKAGE_DROPBEAR_ALLOW_BLANK_PASSWORD),y)
DROPBEAR_POST_EXTRACT_HOOKS += DROPBEAR_ALLOW_BLANK_PASSWORD
endif
