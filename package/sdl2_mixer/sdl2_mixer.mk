...
ifneq ($(BR2_PACKAGE_LIBMODPLUG)$(BR2_PACKAGE_LIBMIKMOD),)
SDL2_MIXER_CONF_OPT += --enable-music-mod
else
SDL2_MIXER_CONF_OPT += --disable-music-mod
endif
...
SDL2_MIXER_CONF_OPT += --enable-music-mod-mikmod \
	LIBMIKMOD_CONFIG=$(STAGING_DIR)/usr/bin/libmikmod-config
SDL2_MIXER_DEPENDENCIES += libmikmod
else
SDL2_MIXER_CONF_OPT += --disable-music-mod-mikmod
endif
